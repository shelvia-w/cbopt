...
SummaryWriter = None
from . import models
from .baselines.ucbopt import uCBOpt
from .baselines.ivon import IVON
from .baselines.adahessian import AdaHessian
from .baselines.duq import DUQ
...
@autoinitcoroutine
def coro_log(
    sw: Optional[SummaryWriter] = None, # type: ignore
    logfreq: int = 100,
    nbin: int = 10,
    save_dir="",
    global_rank = None,
