"""HPC two-stage SGD tuning sweep for LeNet on Fashion-MNIST."""
...
def write_summary(rows: list[dict[str, str | float | int]], best: dict[str, str | float | int]) -> None:
    ...
    recommendation = (
        ...
        "seeds: [0, 1, 2]\n"
        f"device: {DEVICE}\n"
        f"traindir: \"runs/final/sgd/{DATASET}_{MODEL}/"
...
def main() -> None:
    ...
    print(
        ...
        f"runs/final/sgd/{DATASET}_{MODEL}/lr_{best['lr']}_wd_{best['weight_decay']}_ep_100"
    )
