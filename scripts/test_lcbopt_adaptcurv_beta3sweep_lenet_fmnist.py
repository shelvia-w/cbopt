"""Evaluate saved checkpoints for lCBOptAdaptCurv / LeNet / Fashion-MNIST across beta3 values.

Mirrors the hyperparameter layout of train_lcbopt_adaptcurv_beta3sweep_lenet_fmnist.py.
