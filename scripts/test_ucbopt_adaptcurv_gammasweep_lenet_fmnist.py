"""Evaluate saved checkpoints for uCBOptAdaptCurv / LeNet / Fashion-MNIST across gamma values.

Mirrors the hyperparameter layout of train_ucbopt_adaptcurv_gammasweep_lenet_fmnist.py.
