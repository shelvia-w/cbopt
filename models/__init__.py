...
def densenet121_swag(outclass: int, input_size: int = 32, max_rank: int = 20) -> SWAG:
    return SWAG(densenet121(outclass, input_size), max_rank)
...
SWAGMODELS = {
    ...
    "densenet121_swag": densenet121_swag,
}
