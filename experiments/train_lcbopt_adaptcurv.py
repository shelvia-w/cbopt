"""Train a model with the lCBOpt Adaptive Curvature optimizer."""
...
def get_args():
    p = argparse.ArgumentParser(description="lCBOpt Adaptive Curvature training")
    ...
    p.add_argument("-lr", "--learning_rate", default=1e-3, type=float)
