...
def get_args():
    p = argparse.ArgumentParser(description="MC Dropout training")
    ...
    p.add_argument("-lr", "--learning_rate", default=0.1, type=float, help="initial learning rate")
    ...
    p.add_argument("--beta1", default=0.9, type=float, help="coefficient for momentum")
...
def build_model(args, device):
    ...
    # Some model builders accept (num_classes, input_size), while older
    # MCDropout builders may only accept (num_classes,).
    try:
